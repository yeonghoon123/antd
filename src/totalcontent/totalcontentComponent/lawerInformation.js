...
export default function LawerInf() {
    ...
    return (
        <div className="totalContent_LawerInformationContainer">
            ...
            <div className="totalContent_Input">
                상담 노무사
                <Input placeholder="이름을 입력해 주세요." style={{ marginTop: "5px" }} required />
            </div>
            <div className="totalContent_Input">
                상담 유형 선택
                <div className="totalContent_SelectBox">
                    <Select defaultValue="유형 선택" className="totalContent_Input" onChange={handleChange}>
            ...
            <div className="totalContent_LastInput">
                ...
                <div className="totalContent_LastSelectBox">
                    <Select defaultValue="lucy" className="totalContent_LastInput" onChange={handleChange}>
